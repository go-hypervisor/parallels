 ...
 */
#if !defined(_WIN_) && !defined(_LIN_) && !defined(_MAC_)
    /**
...
#define PRL_DLLEXPORT __declspec(dllexport)
...
typedef struct _PRL_HANDLE*	PRL_HANDLE;
...
} __attribute__((packed)) PRL_API_METHOD ;
